...
export const legalPages: LegalPage[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'text', value: 'Unsere Website wird bei der STRATO AG gehostet. STRATO verarbeitet personenbezogene Daten im Rahmen einer Auftragsverarbeitung gemäß Art. 28 DSGVO.' },
      { kind: 'heading', value: '4. Server-Logfiles' },
      { kind: 'text', value: 'Beim Besuch unserer Website erhebt STRATO automatisch Daten wie IP-Adresse, Browsertyp, Betriebssystem, Referrer-URL sowie Datum und Uhrzeit des Zugriffs. Die Verarbeitung erfolgt zur Sicherstellung des technischen Betriebs.' },
      { kind: 'heading', value: '5. Google Analytics' },
      { kind: 'text', value: 'Diese Website nutzt Google Analytics, einen Webanalysedienst der Google Ireland Limited. Google Analytics verwendet Cookies, die eine Analyse der Benutzung der Website ermöglichen. Die IP-Adresse wird anonymisiert. Die Nutzung erfolgt ausschließlich nach Ihrer Einwilligung über das Cookie-Banner.' },
      { kind: 'heading', value: '6. Newsletter' },
      { kind: 'text', value: 'Wenn Sie unseren Newsletter abonnieren, verwenden wir Ihre E-Mail-Adresse ausschließlich für den Versand des Newsletters. Die Anmeldung erfolgt im Double-Opt-in-Verfahren. Sie können den Newsletter jederzeit abbestellen.' },
